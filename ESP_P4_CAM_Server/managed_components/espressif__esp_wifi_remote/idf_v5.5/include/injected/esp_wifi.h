...
/*
 * On ESP32-P4, esp_wifi_remote expects a slave Wi-Fi target to be selected via
 * Kconfig. In this workspace the choice symbol is not materialized into
 * sdkconfig, so we provide the component's documented default (ESP32-C6) here
 * to unblock the build.
 */
#if defined(CONFIG_IDF_TARGET_ESP32P4) && \
    !defined(CONFIG_SLAVE_IDF_TARGET_ESP32) && \
